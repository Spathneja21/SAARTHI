                ...
                children: [
                  ...
                  Expanded(
                    child: PageView(
                      ...
                      children: [
                        AnimatedBuilder(
                          animation: _dailyTaskStore,
                          builder: (context, child) {
                            return DashboardPage(
                              dayTasks: _dailyTaskStore.tasksForDate(
                                DateTime.now(),
                              ),
                            );
                          },
    ...
    await showDialog<void>(
      ...
      builder: (dialogContext) {
        return TaskCreationDialog(
          initialDate: _selectedDate,
          onTaskCreated:
              (title, deadline, durationMinutes, priority, flexibility) {
    ...
    if (dayTasks.isEmpty) {
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('No tasks to delete')));
      }
      return;
    }
